...
const GoogleAdsLandingPage = () => {
  ...
  const content = language === 'it' ? {
    ...
    subtitle: 'Scopri la Soluzione Definitiva per Far Crescere la Tua Attività Online, Senza Sprechi e con la Massima Trasparenza.',
    description: 'La gestione delle campagne pubblicitarie su Google e Facebook può essere complessa e frustrante. Tra budget che si esauriscono senza conversioni, algoritmi in continua evoluzione e la difficoltà di interpretare i dati, spesso ci si sente persi in un labirinto digitale.',
    question: 'E se ti dicessimo che esiste un modo per ottenere risultati reali, con un partner che ha il tuo stesso obiettivo: la crescita del tuo business?',
    ...
    phoneNumber: '800 931 785'
  } : {
    title: 'Tired of Advertising Campaigns That Don\'t Deliver Real Results?',
    subtitle: 'Discover the Ultimate Solution to Grow Your Online Business, Without Waste and with Maximum Transparency.',
    description: 'Managing advertising campaigns on Google and Facebook can be complex and frustrating. Between budgets that run out without conversions, constantly evolving algorithms, and the difficulty of interpreting data, you often feel lost in a digital maze.',
    question: 'What if we told you there\'s a way to get real results, with a partner who shares your goal: growing your business?',
