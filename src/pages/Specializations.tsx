...
export default function Specializations() {
  ...
  const content = {
    ...
    subtitle: language === 'it' ? 'Expertise in Marketing Digitale' : 'Digital Marketing Expertise',
    description: language === 'it'
      ? 'Soluzioni specializzate per ogni aspetto del tuo marketing digitale'
      : 'Specialized solutions for every aspect of your digital marketing'
  };
