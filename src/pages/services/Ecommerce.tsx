...
export default function Ecommerce() {
  ...
  const content = language === 'it' ? {
    ...
    description: 'Strategie di marketing digitale specifiche per e-commerce che massimizzano conversioni e fatturato',
    features: [
      {
    ...
    description: 'Specific digital marketing strategies for e-commerce that maximize conversions and revenue',
    features: [
      {
