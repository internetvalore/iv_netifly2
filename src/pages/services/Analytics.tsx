...
export default function Analytics() {
  ...
  const content = language === 'it' ? {
    ...
    description: 'Monitoriamo e ottimizziamo le performance con dati in tempo reale e report dettagliati',
    features: [
      {
    ...
    description: 'We monitor and optimize performance with real-time data and detailed reports',
    features: [
      {
