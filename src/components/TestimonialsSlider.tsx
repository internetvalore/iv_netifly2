            ...
            >
              {featuredReviews.map((review, index) => (
                ...
                >
                  ...
                  >
                    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 cursor-pointer h-full flex flex-col">
                      <div className="flex items-start mb-4">
                        ...
                        <div>
                          <p className="text-lg leading-6 font-medium text-gray-900">{review.author}</p>
                          {review.company && (
